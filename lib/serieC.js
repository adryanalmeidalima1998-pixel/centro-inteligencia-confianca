...
export function isGuaraniTeam(name) {
  const n = normTeamName(name)
  if (!n) return false
  // O normalizador remove acentos: CONFIANÇA -> CONFIANCA.
  return n === 'CONFIANCA' || n.startsWith('CONFIANCA ') || n.startsWith('AD CONFIANCA ') || n.startsWith('ASSOCIACAO DESPORTIVA CONFIANCA')
}
