...
const REPORT_SCHEMA = {
  ...
  required:['resumo_executivo','titulos_principais','sistemas_taticos','modelo_jogo','pontos_fortes','pontos_melhoria','perfis_jogadores','adaptabilidade','filosofia_declarada','fonte_filosofia','coerencia_discurso_dados','referencias_externas','recomendacao','justificativas_recomendacao','sintese_final','fontes_publicas']
}
...
const TEXT_SOURCE_SCHEMA = {
  ...
  required:['resumo_executivo','titulos_principais','sistemas_taticos','modelo_jogo','pontos_fortes','pontos_melhoria','perfis_jogadores','adaptabilidade','filosofia_declarada','fonte_filosofia','coerencia_discurso_dados','referencias_externas','recomendacao','justificativas_recomendacao','sintese_final','evidencias_extraidas']
}
...
12) Retorne todos os campos do schema em português do Brasil.`
  ...
  return responsesJson({ instructions, input, schema:TEXT_SOURCE_SCHEMA, schemaName:'coach_text_source_analysis', web:false, timeoutMs:52000 })
}
