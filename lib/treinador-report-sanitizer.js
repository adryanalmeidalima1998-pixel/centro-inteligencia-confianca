const UNSUPPORTED_PATTERNS = [
  ...
  /comportamento\s+espec[ií]fico\s+n[aã]o\s+est[aá]\s+descrito/i,
  /n[aã]o\s+h[aá]\s+material\s+suficiente/i,
  /ainda\s+[ée]\s+necess[aá]rio\s+(?:relacionar|verificar|validar|confirmar)/i,
  /n[aã]o\s+est[aã]o\s+definid[oa]s?\s+no\s+material/i,
  /n[aã]o\s+permitem?\s+validar/i,
]
