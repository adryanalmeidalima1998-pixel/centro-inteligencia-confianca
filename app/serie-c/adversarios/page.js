  ...
  useEffect(()=>{
    ...
    ;(async()=>{
      try{
        ...
        if(!cancelled)setClubLast10(parsed)
      }catch(_){ if(!cancelled)setClubLast10(null) }
    })()
